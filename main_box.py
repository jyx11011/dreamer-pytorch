...
def build_and_train(log_dir, game='box', run_ID=0, cuda_idx=None, eval=False, save_model='last', load_model_path=None, sample_rand=1):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--game', help='game', default='box')
